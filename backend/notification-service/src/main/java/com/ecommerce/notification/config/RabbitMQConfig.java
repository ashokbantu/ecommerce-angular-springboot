...
public class RabbitMQConfig {
    ...
    public Queue paymentStatusQueue() {
        return new Queue(AppConstants.PAYMENT_STATUS_QUEUE, true);
    }
    ...
    @Bean
    public Binding paymentStatusBinding(Queue paymentStatusQueue, DirectExchange ecommerceExchange) {
        return BindingBuilder.bind(paymentStatusQueue).to(ecommerceExchange).with(AppConstants.PAYMENT_STATUS_ROUTING_KEY);
    }
